...
//
// This is the M0 (minimal) context: only the fields required for the
// attention-boundary sequence-parallel milestone. Independent performance
// capabilities (MMRS fusion, quantized all-gather, router sequence
// parallelism) are added in later milestones so they can be measured and gated
// on their own.
